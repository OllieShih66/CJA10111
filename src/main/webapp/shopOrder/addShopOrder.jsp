...
<head>
<meta charset="UTF-8">
<title>商品訂單資料新增 - addShopOrder.jsp</title>
</head>
<body>
	<style>
table#table-1 {
...
<body bgcolor='white'>
	...
	<table id="table-1">
		<tr>
			<td>
				<h3>商品訂單資料新增 - addShopOrder.jsp</h3>
			</td>
			<td>
				<h4>
					<a href="select_page.jsp"><img src="image/logo.svg"
		...
		<table>
			...
			<tr>
				...
				<td><input type="TEXT" name="memId"
					value="<%=(sovo == null) ? "10000001" : sovo.getMemId()%>" size="45" /></td>
			</tr>
<!-- 			<tr> -->
<!-- 				<td>訂單日期:</td> -->
<%-- 				<td><input type="TEXT" name="shopOrderDate" value="<%=time%>" --%>
<!-- 					size="45" readonly /></td> -->
<!-- 			</tr> -->
			<tr>
				<td>出貨方式:</td>
			...
			<tr>
				...
				<td><input name="shopOrderShipFee" id="ship_fee" type="text"
					value="<%=(sovo == null) ? "60" : sovo.getShopOrderShipFee()%>" size="45" /></td>
			</tr>
			<tr>
				<td>折價前總金額:</td>
				<td><input name="beforeDiscountAmount" id="before_discount"
					type="text" value="1200" size="45" /></td>
			</tr>
			
			<tr>
				<td>折價券編號:</td>
				<td><input name="discountCodeId" id="discount_code" type="text"
					value="<%=(sovo == null) ? "" :sovo.getDiscountCodeId()%>" size="45" /></td>
			</tr>
			<tr>
				<td>折價金額:</td>
				<td><input name="discountAmount" id="discount_amount"
					type="text" value="<%=(sovo == null) ? "0" : sovo.getDiscountAmount()%>" size="45" /></td>
			</tr>
			<tr>
				<td>實付金額:</td>
				<td><input name="afterDiscountAmount" id="after_discount"
					type="text" value="<%= (sovo == null)
					        ? "0" : sovo.getAfterDiscountAmount()%>" size="45" /></td>
			</tr>
			<tr>
				<td>付款方式:</td>
			...
			<tr>
				...
				<td><input name="orderName" id="order_name" type="text"
					value="<%=(sovo == null) ? " " : sovo.getOrderName()%>" size="45" /></td>
			</tr>
			<tr>
				<td>訂購人郵件:</td>
				<td><input name="orderEmail" id="order_email" type="text"
					value="<%=(sovo == null) ? "@gmail.com" : sovo.getOrderEmail()%>" size="45" /></td>
			</tr>
			<tr>
				<td>訂購人手機:</td>
				<td><input name="orderPhone" id="order_phone" type="text"
					value="<%=(sovo == null) ? " " :sovo.getOrderPhone()%>" size="45" /></td>
			</tr>
			<tr>
				<td>訂購人地址:</td>
				<td><input name="orderShippingAddress" id="order_address"
					type="text" value="<%=(sovo == null) ? " " : sovo.getOrderShippingAddress()%>" size="45" /></td>
			</tr>
			<tr>
				<td>訂購備註:</td>
				<td><input name="shopOrderNote" id="order_note" type="text"
					value="<%=(sovo == null) ? " " : sovo.getShopOrderNote()%>" size="45" /></td>
			</tr>
			<tr>
				<td>出貨日期:</td>
				<td><label for="date">請選擇日期：</label> <input type="date"
					id="date" name="date" required value="2025-01-01"> <br> <label for="time">請選擇時間：</label>
					<input type="time" id="time" name="time" required value="00:00"> <br>
			</tr>
			<tr>
