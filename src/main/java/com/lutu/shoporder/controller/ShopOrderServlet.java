...
public class ShopOrderServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		if ("update".equals(action)) { // 來自update_emp_input.jsp的請求
			...
			String dateStr = req.getParameter("date"); // 2024-05-28
			String timeStr = req.getParameter("time"); // 10:30
			String dateTimeStr = dateStr + "T" + timeStr; // 2024-05-28T10:30
			LocalDateTime shopOrderShipDate = LocalDateTime.parse(dateTimeStr);
			...
			/*************************** 2.開始修改資料 *****************************************/
			ShopOrderService sos = new ShopOrderService();
			sovo = sos.updateShopOrder(shopOrderShipment, shopOrderShipFee, beforeDiscountAmount, discountCodeId, 
					discountAmount, afterDiscountAmount, shopOrderPayment, orderName, orderEmail, orderPhone, orderShippingAddress,
					shopOrderNote, shopOrderShipDate, shopOrderStatus, shopReturnApply, shopOrderId, memId);
